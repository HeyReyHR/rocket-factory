...
import (
	...
	"github.com/HeyReyHR/rocket-factory/notification/internal/app"
...
const configPath = "/home/heyrey/cool_projects/rocket-factory/deploy/compose/notification/.env"

// const configPath = "deploy/compose/notification/.env" // Ревьюверу: как мне избежать этого при коммите?
