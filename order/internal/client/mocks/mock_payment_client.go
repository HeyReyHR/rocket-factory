...
// PayOrder provides a mock function with given fields: ctx, uuid, method
func (_m *PaymentClient) PayOrder(ctx context.Context, uuid string, method model.PaymentMethod) (string, error) {
...
func (_e *PaymentClient_Expecter) PayOrder(ctx interface{}, uuid interface{}, method interface{}) *PaymentClient_PayOrder_Call {
	return &PaymentClient_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, uuid, method)}
}

func (_c *PaymentClient_PayOrder_Call) Run(run func(ctx context.Context, uuid string, method model.PaymentMethod)) *PaymentClient_PayOrder_Call {
...
func (_c *PaymentClient_PayOrder_Call) RunAndReturn(run func(context.Context, string, model.PaymentMethod) (string, error)) *PaymentClient_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
