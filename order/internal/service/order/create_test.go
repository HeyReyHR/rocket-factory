...
func inventoryClientListPartsOutOfStock() []model.Part {
	return []model.Part{
		{
			Uuid:          "engine-002",
...
func inventoryClientListPartsCreateSuccess() (model.PartsFilter, []model.Part, []string) {
	return model.PartsFilter{
			Uuids: []string{"engine-002"},
		}, []model.Part{{
			Uuid:          "engine-002",
			Name:          "Advanced Turbo Engine",
			Description:   "Next-generation turbo rocket engine",
