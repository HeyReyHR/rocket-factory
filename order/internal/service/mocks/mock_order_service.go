...
func (_c *OrderService_Create_Call) Return(uuid string, totalPrice float64, err error) *OrderService_Create_Call {
	_c.Call.Return(uuid, totalPrice, err)
	return _c
}
...
func (_m *OrderService) Pay(ctx context.Context, uuid string, paymentMethod model.PaymentMethod) (string, error) {
...
func (_c *OrderService_Pay_Call) Run(run func(ctx context.Context, uuid string, paymentMethod model.PaymentMethod)) *OrderService_Pay_Call {
	_c.Call.Run(func(args mock.Arguments) {
