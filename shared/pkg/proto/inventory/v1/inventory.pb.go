...
// Optional filter to list certain parts
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"\x1cinventory/v1/inventory.proto\x12\finventory.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"U\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBOZMgithub.com/HeyReyHR/rocket-factory/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	5,  // 0: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
	7,  // 1: inventory.v1.ListPartsResponse.parts:type_name -> inventory.v1.Part
	7,  // 2: inventory.v1.GetPartResponse.part:type_name -> inventory.v1.Part
